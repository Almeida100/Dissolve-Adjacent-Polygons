...
from .dissolve_adjacent_polygons_algorithm import DissolveAdjacentPolygons


class DissolveAdjacentPolygonsProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(DissolveAdjacentPolygons())
    ...
    def name(self):
        ...
        """
        return self.tr('Dissolve adjacent polygons')
